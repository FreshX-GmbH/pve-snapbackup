...
module.exports = function (name, pwd, hostname, realm) {
    const apiURL = `https://${hostname}:8006/api2/json`;
    const authString = `username=${name}&password=${pwd}&realm=${realm}`;
